                                ...
                                <table class="table table-bordered table-hover datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Kategori</th>
                                            <th>Updated</th>
                                            @canany(['update programtypes', 'delete programtypes'])
                                                <th>Action</th>
                                            @endcanany
                                        </tr>
                                    </thead>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('programtypes.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('programtypes.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        <div class="input-group">
                            <label>Name</label>
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('programtypes.destroy') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
